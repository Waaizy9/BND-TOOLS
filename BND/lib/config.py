"""BND-TOOLS — settings.json load/save."""
import json
import os
...
class Settings:
    ...
    def load(self):
        ...
        if os.path.isfile(C.SETTINGS_PATH):
            try:
                ...
                pass
        C.apply_theme(C._THEME_ALIASES.get(self.data.get("theme", "blue"), self.data.get("theme", "blue")))
    ...
    @property
    def username(self):
        return self.data.get("username", "BND_User")
